...
"font: bold;")
    ...
    def retranslateUi(self, HomeWindow):
        ...
        self.sgtPurchase1.clicked.connect(partial(self.displayPC, 1))
        ...
        self.sgtPurchase2.clicked.connect(partial(self.displayPC, 2))
        ...
        self.sgtPurchase3.clicked.connect(partial(self.displayPC, 3))
        ...
        self.popularPurchase1.clicked.connect(partial(self.displayPC, 4))
        ...
        self.popularPurchase2.clicked.connect(partial(self.displayPC, 5))
        ...
        self.popularPurchase3.clicked.connect(partial(self.displayPC, 6))

    def setStack(self, stack):
        self.stack = stack

    def displayPC(self, pc_id):
        db = mysql.connector.connect(user="root", passwd="root", host="localhost", db="pa_store")
        cursor = db.cursor()
        for build in Sql.fetchFromDatabase(cursor, "prebuild", condition=f"id = {pc_id}"):
            print(f"CPU: {build[1]}")
            print(f"GPU: {build[2]}")
            print(f"Memory: {build[3]}")
            print(f"Motherboard: {build[4]}")
            print(f"Case: {build[5]}")
            print(f"Price: {build[6]}")
