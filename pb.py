...
"")
    ...
    def retranslateUi(self, pbMenu):
        ...
        self.memBtn.setText(_translate("pbMenu", "Memory"))
        self.moboBtn.setText(_translate("pbMenu", "Motherboards"))
        self.caseBtn.setText(_translate("pbMenu", "Cases"))
